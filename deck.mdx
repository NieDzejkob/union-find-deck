...
steps={g => [
    // Union Find ma strukturę lasu drzew, w którym korzenie są reprezentantami
    // spójnych składowych. Każdy wierzchołek pamięta, kto jest jego rodzicem.
    ['reset', [['blue', 4], ['blue', 8]]],
    ...
    ['replace'],
    // Najpierw musimy znaleźć reprezentantów za pomocą Finda.
    ['add', [['orange', 3], ['orange', 3, 5, 'arrow'], ['orange', 9], ['orange', 9, 8, 'arrow']],
